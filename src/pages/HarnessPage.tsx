...
export function HarnessPage() {
  return <div className="page-fade case-page harness-page">
    ...
    <CaseSection id="why-evaluate" no="01" label="WHY EVALUATE" title="GENERATED IS ONLY THE START" intro="一份 PPT 不应只通过“是否生成成功”判断，而应同时考虑内容、结构、视觉、图文匹配、事实准确性、可编辑性和具体使用场景。">
      <div className="big-statement"><span>SUCCESS ≠ QUALITY</span><p>评测把模糊的“看起来不对”转化为可以定位、解释和进入产品迭代的问题。</p></div>
    </CaseSection>
    <CaseSection id="good-ppt" no="02" label="WHAT IS GOOD" title="QUALITY IS CONTEXTUAL">
      <div className="quality-equation"><span>GOOD PPT</span><i>=</i><div><b>清晰内容</b><b>连贯结构</b><b>有效视觉</b><b>适配场景</b></div></div>
    </CaseSection>
    <CaseSection id="dimensions" no="03" label="DIMENSIONS" title="SEVEN LENSES, ONE SYSTEM">
    ...
    <CaseSection id="tasks" no="04" label="TASK & SAMPLE DESIGN" title="TEST THE SCENARIO, NOT A TEMPLATE" intro="任务覆盖不同受众、时长、内容密度和表达目标，以观察同一套生成能力在不同使用场景中的表现。">
    ...
    <CaseSection id="rubric" no="05" label="HUMAN RUBRIC" title="MAKE JUDGEMENT CONSISTENT">
    ...
    <CaseSection id="ai-flow" no="06" label="AI EVALUATION FLOW" title="RULES, MODELS & HUMAN REVIEW" dark>
    ...
    <CaseSection id="taxonomy" no="07" label="ERROR TAXONOMY" title="NAME THE PROBLEM">
    ...
    <CaseSection id="dashboard" no="08" label="RESULT DASHBOARD" title="FROM SCORE TO EVIDENCE" intro="面板同时展示总体得分、七项能力、高频错误、页面问题与样本差异；示意数字仅用于展示界面结构。">
    ...
    <CaseSection id="optimize" no="09" label="PRODUCT FEEDBACK LOOP" title="TURN ERRORS INTO PRODUCT WORK">
    ...
    <CaseSection id="limits" no="10" label="LIMITS & NEXT" title="A SCORE IS NOT THE ANSWER">
    ...
    <NextProject label="PURO COFFEE" to="/work/puro-coffee" />
  </div>
}
