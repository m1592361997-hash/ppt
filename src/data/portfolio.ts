...
export const portfolio = {
  ...
  hero: {
    ...
    title: ['DESIGNING BETTER', 'AI PRESENTATION', 'EXPERIENCES.'],
  ...
  skillGroups: [
    { title: 'RESEARCH', items: ['用户访谈', '问卷设计', '竞品分析', '用户旅程', '需求归纳'] },
    { title: 'PRODUCT', items: ['问题定义', '产品策略', '功能架构', '用户流程', '交互原型'] },
    { title: 'AI', items: ['Prompt 设计', '模型体验', '输出评测', '错误归因', 'AI 辅助创作'] },
    { title: 'VISUAL', items: ['PPT 设计', '信息可视化', '品牌视觉', '出版插画', '内容转译'] },
  ],
  process: [
    { no: '01', title: 'DISCOVER', text: '理解用户、任务和真实场景' },
    { no: '02', title: 'DEFINE', text: '识别关键问题与产品机会' },
    { no: '03', title: 'DESIGN', text: '设计流程、界面和 AI 能力' },
    { no: '04', title: 'EVALUATE', text: '评测输出并定位问题' },
    { no: '05', title: 'ITERATE', text: '根据反馈持续优化' },
  ],
  projects: [
    { no: '01', slug: 'wps-ai-ppt', title: 'WPS AI PPT', subtitle: 'FROM GENERATION TO CO-CREATION', description: '从“一键生成”到“可理解、可控制、可修改”的 AI PPT 创作体验。', tags: ['USER RESEARCH', 'COMPETITIVE ANALYSIS', 'AI PRODUCT DESIGN', 'PROTOTYPE'], type: 'INDEPENDENT CONCEPT PROJECT · 独立概念项目', tone: 'coral' },
    { no: '02', slug: 'ppt-quality-harness', title: 'PPT QUALITY HARNESS', subtitle: 'EVALUATING AI-GENERATED PRESENTATIONS', description: '建立一套可解释的 AI PPT 生成质量评测体系。', tags: ['AI EVALUATION', 'HARNESS DESIGN', 'DATA ANALYSIS', 'ITERATION'], tone: 'blue' },
    { no: '03', slug: 'puro-coffee', title: '个人 PPT 制作作品', subtitle: 'PERSONAL POWERPOINT PORTFOLIO', description: '在单一主色限制下，通过构图、字体层级和图形系统建立连续的产品视觉表达。', tags: ['VISUAL SYSTEM', 'CONTENT DESIGN', 'CAMPAIGN', 'DELIVERY'], type: 'REAL VISUAL DESIGN PROJECT', tone: 'warm' },
  ],
  visualWorks: [
  ...
  wps: {
    title: 'WPS AI PPT', subtitle: ['FROM GENERATION', 'TO CO-CREATION'], claim: '从一键生成，到人机共同完成一份好 PPT。',
  ...
  harness: {
    title: 'PPT QUALITY HARNESS', subtitle: ['EVALUATING', 'AI-GENERATED PRESENTATIONS'], summary: '建立一套可解释、可复用的 AI PPT 生成质量评测框架。',
  ...
  puro: {
    title: 'PURO COFFEE', subtitle: ['VISUAL SYSTEM', '& CONTENT DESIGN'], summary: '围绕咖啡产品完成电商平台海报及相关视觉物料，在主理人限定单一主色的条件下，通过构图、文字层级、产品信息和图形系统建立连续而有区分度的视觉表达。',
